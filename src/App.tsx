...
export default function App() {
  ...
  const HARDCODED_SHEET_ID = '1Irtfvymu26CShYowLMMfD-rM0o9CJqE6-BBSlYsAaF4';
  const HARDCODED_SHEET_GID = '0'; // Recent tab
            ...
            >
              ...
              <div className="space-y-4 mb-8 text-sm text-white/70 leading-relaxed">
                <ul className="space-y-4">
                  <li>
                    <strong className="text-white">New Logo</strong>
                    <p className="mt-1">VAMPgold has a fresh new VG-01 logo design</p>
                  </li>
                  <li>
