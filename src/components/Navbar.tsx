        ...
        <div className="flex-1 flex flex-row items-center justify-between md:justify-start w-full relative gap-3">
          <div className="md:hidden flex items-center shrink-0">
            <img
              ...
              alt="YZY Gold"
              onClick={onHomeClick}
              className="h-[64px] w-[210px] object-cover object-center cursor-pointer hover:opacity-80 transition-opacity duration-300"
            />
          </div>
          ...
          {activeCategory !== 'history' && (
            ...
            >
              ...
              <div className="hidden md:block w-[220px] h-[80px] shrink-0 overflow-hidden">
                <img
                  src="/logo.png"
                  alt="YZY Gold"
                  onClick={onHomeClick}
