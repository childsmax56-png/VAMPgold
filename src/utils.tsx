...
export const ALBUM_DESCRIPTIONS: Record<string, string> = {
  ...
  "Ongoing": "",
  "Aviation Class": "(Sep 13, 1995) - Jordan Terrell Carter is born\n\n(~2009) - JCee starts making music\n\n(Sep 19, 2010) - JCee announces Aviation Class officially starting his music career\n\n(???) - Aviation Class morphs into Killing Me Softly\n\n(Apr 10, 2011) - JCee adapts the name \"$ir Cartier\"",
  "Killing Me Softly": "(Apr 10, 2011) - JCee adapts the name \"$ir Cartier\"\n\n(???) - Aviation Class morphs into Killing Me Softly\n\n(Mid 2011) - Killing Me Softly morphs into The High Chronical$",
  "THC: The High Chronicals": "(Mid 2011) - Killing Me Softly morphs into The High Chronical$\n\n(Nov 5, 2011) - The High Chronical$ is officially released",
  "Kream": "(Nov 5, 2011) - The High Chronical$ is officially released\n\n(Fall 2012) - Kream morphs into Young Mi$fit",
  "Young Mi$fit": "(Fall 2012) - Kream morphs into Young Mi$fit\n\n(Nov 11, 2012) - Young Mi$fit is officially released",
  "Sen$ation": "(Nov 11, 2012) - $ir Cartier officially releases \"Young Mi$fit\"\n\n(October ??th, 2013) - Sen$ation fails to release & is most likely scrapped\n\n(Jan 8, 2014) - $ir Cartier changes his moniker to Playboi Carti",
  "Ca$h Carti Season": "(Jan 2016) - Playboi Carti's aesthetic and sound shifts\n\n(Sep 9, 2016) - Playboi Carti signs to Interscope + AWGE and decides to rework his mixtape",
  "Playboi Carti": "(September 9, 2016) - Playboi Carti signs to Interscope + AWGE\n\n(April 14, 2017) - Playboi Carti is officially released",
  "16*29": "(Mid 2017) - The project is conceived\n\n(January 3rd & 4th, 2018) - Major sessions for the project occur at the Paramount Hotel in New York City",
  "Die Lit": "(April 14, 2017) - Playboi Carti releases \"Playboi Carti\"\n\n(May 11, 2018) - Playboi Carti releases \"Die Lit\"",
  "Whole Lotta Red [V1]": "(May 11, 2018) - Die Lit is officially released\n\n(June 3rd, 2018) - While previewing Buffy The Body, Carti says that Die Lit 2 is coming soon\n\n(Aug 9, 2018) - Carti makes Skeleton, where he mentions Whole Lotta Red, making the name change from \"Die Lit 2\" to \"Whole Lotta Red\" official\n\n(July 29, 2019) - Travis Scott posts a video of an unreleased Carti track",
  "Whole Lotta Red [V2]": "(Sep 30, 2019) - Carti fails to drop in \"the next 60 days\"\n\n(Oct 16, 2019) - Landmark session happens\n\n(April 16, 2020) - @ MEH releases and receives poor reception\n\n(June 28, 2020) - BigSosa, Carti's long-time friend passes, sending Carti into a hiatus and causing a change of sound",
  "Whole Lotta Red [V3]": "(Apr 14, 2020) - @ MEH releases to poor reception from fans\n\n(June 28th, 2020) - BigSosa, Carti's long-time friend passes away, sending Carti into a hiatus\n\n(Summer 2020) - Carti starts exploring a darker sound\n\n(November 2020) - Ye becomes executive producer and the album sound shifts",
  "Whole Lotta Red [V4]": "(November 2020) - Ye becomes executive producer and the album sound shifts\n\n(December 25, 2020) - Whole Lotta Red is officially released",
  "Narcissist": "(Early 2021) - Whole Lotta Red (Deluxe) gets shelved\n\n(March 10, 2021) - Carti posts about wanting to drop soon\n\n(July 7, 2021) - Carti goes to the Mercedes Benz Stadium to work on Donda\n\n(August 23, 2021) - Carti posts a fit pic on IG captioned: \"NARCISSIST 09/13/21\"\n\n(September 13, 2021) - NARCISSIST does not release",
  "WE DON'T DIAL 911": "(Early 2019) - Carti and Trippie Redd start working on a collab EP\n\n(Late 2019) - The EP is scrapped",
  "MUSIC [V1]": "(Sep 13, 2021) - Playboi Carti fails to release \"Narcissist\"\n\n(Mar 10, 2022) - Playboi Carti reveals the album is now called \"MUSIC\" in an interview with XXL\n\n(Dec 24, 2022) - Playboi Carti ends his social media hiatus by posting what is believed to be the album cover on Instagram",
  "MUSIC [V2]": "(Jan 13, 2023) - Playboi Carti fumbles the alleged album release date, scrapping the concept planned\n\n(Late May 2023) - Carti starts to shift towards an industrial, dark, and experimental sound\n\n(June 2023) - Carti tours across Europe and temporarily resides in Paris",
  "MUSIC [V3]": "(October 2023) - Carti heads to Italy to record for VULTURES\n\n(Nov 2023) - The MUSIC sessions begin\n\n(Jan 5, 2024) - MUSIC supposedly is meant to drop, it does not\n\n(Mar 14, 2025) - MUSIC releases on all DSPs",
  "BABY BOI": "(January 2023) - The concept of 2 albums dropping back to back is conceived\n\n(March 14, 2025) - MUSIC releases on all DSPs\n\n(March 15, 2025) - Carti posts a screenshot of the Apple Music charts captioned \"BABY BOI OTW\" on Instagram",
  "CARTI YE": "(October 2023) - Carti starts working with Ye on Vultures in Italy\n\n(March 15th, 2025) - Ye confirms that the collab album exists and got scrapped because of the beef between them",
  "VULTURES": "(Mid 2023) - The project is conceived\n\n(October 2023) - Carti starts working with Ye on Vultures in Italy\n\n(Feb 10, 2024) - Vultures 1 is officially released\n\n(Aug 3, 2024) - Vultures 2 is officially released"
};
